...
export function Hero() {
  return (
    <section id="top" className="gradient-hero relative overflow-hidden">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 md:py-28 lg:grid-cols-2 lg:py-32">
        <div>
        ...
        <div className="relative">
          <div className="aspect-[4/5] w-full overflow-hidden rounded-3xl bg-primary/10 shadow-soft">
            <img
              src={heroImage}
          ...
          <div className="absolute -bottom-6 -left-6 rounded-2xl bg-background p-5 shadow-card md:-left-10">
            <div className="text-xs text-muted-foreground">Investering per deelnemer</div>
            <div className="font-display text-3xl font-bold text-primary">€2.950</div>
            <div className="text-xs text-muted-foreground">incl. lesmateriaal & lunch</div>
          </div>
        </div>
      </div>
    </section>
